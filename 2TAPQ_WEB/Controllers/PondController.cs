...
namespace _2TAPQ_WEB.Controllers
{
    public class PondController : Controller
    {
        ...
        public async Task<bool> checkFish(PondDiary diary, string idpond)
        {
            ...
            {
                if (p.IdFcategoryNavigation.Temperature != null && (p.IdFcategoryNavigation.Temperature < (diary.Temperature - 4) || p.IdFcategoryNavigation.Temperature > (diary.Temperature + 4)))
                {
                    return false;
                }
